...
class Param_bioclimaticos:
    ...
    def I(self):
        for i in tqdm(range(0,len(self.grid_lat))):
            for j in range(0,len(self.grid_lon)):
                ...
                if var_pr[0]!=np.nan:
                    ...
                    self.bio5[i][j]=np.nan
                    self.bio6[i][j]=np.nan
                    self.bio8[i][j]=np.nan
                    self.bio9[i][j]=np.nan
                    self.bio10[i][j]=np.nan
                    self.bio11[i][j]=np.nan
                    self.bio13[i][j]=np.nan
                    self.bio14[i][j]=np.nan
                    self.bio16[i][j]=np.nan
                    self.bio17[i][j]=np.nan
                    self.bio18[i][j]=np.nan
                    self.bio19[i][j]=np.nan
